	...
	, m_pGoodsModel(NULL)
{
	...
	connect(ui.lineEdit_portcode, &QLineEdit::textChanged, [this] {this->slotSetNotNull(ui.lineEdit_portcode);});
	connect(ui.lineEdit_portname, &QLineEdit::textChanged, [this] {this->slotSetNotNull(ui.lineEdit_portname);});
}
